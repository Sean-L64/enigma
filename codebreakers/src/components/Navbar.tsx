...
export default function Navbar() {
    ...
    return (
        ...
        md:px-32  backdrop-blur-md drop-shadow-2xl fadeInDown" id="header">
                    <TopScroll />
                    <NavLink to="/"><ScrambledText text="ENIGMA" speed={50} className="nav-title transition-all text-3xl font-extrabold fadeInDown" /></NavLink>
            ...
            " id="navlist"
                    >
                        ...
                        <NavLink to="/history" className="p-1  hover:text-white 
                rounded-md transition-all cursor-pointer text-lg  text-center nav-items hover:scale-140"
                        ><ScrambledText text="History" speed={35} />
                            {/* of the machines */}
                        </NavLink>
                        <NavLink to="/machines" className="nav-items p-1  hover:text-white 
                rounded-md transition-all cursor-pointer text-lg hover:scale-140 ">
                            <ScrambledText text="Machines" speed={35} />
                            {/* Enigma, Turing's Machine, Cyclometer */}
                        </NavLink>



                        <NavLink to="/impact" className=" hover:text-white 
                rounded-md transition-all cursor-pointer text-lg text-center nav-items p-1 hover:scale-140">
                        ...
                        <div className="relative group inline-block text-left " >
                            ...
                            transition-all nav-items ">
                                <ScrambledText text="People" speed={35}/>
                            </button>
                ...
                rounded-md transition-all cursor-pointer text-lg  text-center nav-items p-1 hover:scale-140">
                        ...
                        <NavLink to="/bibliography" className="hover:text-white 
                rounded-md transition-all cursor-pointer text-lg  text-center nav-items p-1 hover:scale-140">
